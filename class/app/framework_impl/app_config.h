	...
	public DFramework::Configuracion_base
{
	...
	input_jugador acc_left() const	{return token_por_ruta_input("left");}
	input_jugador acc_right() const 	{return token_por_ruta_input("right");}
	input_jugador acc_up() const 	{return token_por_ruta_input("up");}
	input_jugador acc_down() const		{return token_por_ruta_input("down");}
	input_jugador acc_jump() const	{return token_por_ruta_input("jump");}
